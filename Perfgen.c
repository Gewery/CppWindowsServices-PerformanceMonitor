...
#define CONSTANT_VALUE_VALUE_2    60
//
...

{
    ...
    if (! dwOpenCount) {
        ...
        SigGenDataDefinition.ConstantValueDef2.CounterNameTitleIndex += dwFirstCounter;
        SigGenDataDefinition.ConstantValueDef2.CounterHelpTitleIndex += dwFirstHelp;
...
--*/
{
    ...
    for (dwThisInstance = 0; dwThisInstance < NUM_INSTANCES; dwThisInstance ++) {
        ...
        pSC->dwConstantValue2 = (DWORD)CONSTANT_VALUE_VALUE_2;
